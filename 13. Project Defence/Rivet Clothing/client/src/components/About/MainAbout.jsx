...
export const MainAbout = () => {
    ...
    return (
        <section className={styles['about-wrapper']}>
            <AboutTitle title="About Us" subtitle="Welcome to our clothing store, where fashion meets affordability!" />
